 ...
 * The gap junctional intercellular communication (GJIC) is modelled by adding coupling equations for IP$_3$, calcium, potassium, sodium, and chloride ions.
 * A linear coupling equation is used for IP$_3$.
 * Electrodiffusion equation is used for calcium, potassium, sodium, and chloride.
 * The intracellular concentrations of potassium, sodium, and chloride ions assumed constant.
...
int main(int argc, char* argv[]){
	...
	/* Simulation controlling parameters */
		...
		number_G_gj = (int *) malloc(sizeof(int)); // Total number of gap junctions
		...
		var_tot	= num_cell[0] * num_var[0];
	 	...
	 	number_G_gj[0] = number_Gj_base; // Total number of gap junctions
	 	IP3_P[0] = number_G_gj[0] * IP2_GJ/Vol_cyt;
	 	Ca_SD_P[0] = number_G_gj[0] * IPF_GJ* z_Ca;
