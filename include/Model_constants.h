...
const double  	Sum_ion_cyt = 	K_cyt + Na_cyt + Cl_cyt;  ///< Sum of ionic Concentrations in cytosol, nM
...
/* Boundary values of agonist concentration in the sigmoidal disribution */
const double   stim_NE 			= 40000;
const double   nonstim_NE 		= 175;


/* Calcium coupling parameters */
const double IP_GJ = 2.4e-19; ///< unitary gap junctional permeability of ions, m3/s
const double IPF_GJ = IP_GJ * F * 1e6; ///< single channel, pC nM-1 s-1
const double IP2_GJ = IP_GJ * 1e15; ///< unitary gap junctional permeability of ions, pL/s
